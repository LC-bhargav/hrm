...
export const GoogleGeminiEffect = ({
    ...
    return (
        <div className={cn("sticky top-40", className)}>
            <p className="text-5xl md:text-8xl font-bold pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-blue-400 via-blue-100 to-white">
                {title}
            </p>
            <p className="text-lg md:text-2xl font-normal text-center text-slate-400 mt-4 max-w-2xl mx-auto px-4">
                {description}
            </p>
            ...
            <svg
                ...
                className="absolute -top-20 md:-top-10 w-full opacity-80"
            >
                <motion.path
